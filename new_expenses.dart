              ...
              children: [
                if (width >= 600)
                  Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Expanded(child: TextField(controller: _titleController, label: const Text('Title'), maxLength: 50)),
                  ...
                  TextField(controller: _titleController, maxLength: 50, decoration: const InputDecoration(label: Text('Title'))),
                // (Remaining rows for Category and Date Picker...)
                ElevatedButton(onPressed: _submitData, child: const Text('Save Expense')),
              ],
            ),
          ),
        ),
